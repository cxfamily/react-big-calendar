  ...
  */
          ...
          return /*#__PURE__*/ React__default.createElement(
            ...
            /*#__PURE__*/ React__default.createElement('div', {
              ...
              className: clsx(
                ...
                eq$1(date, current, 'day') && reactStyle['rbc-today'],
                currentDate &&
  ...
  var DateContentRow = /*#__PURE__*/ (function(_React$Component) {
      ...
      _this.renderHeadingCell = function(date, index) {
        ...
        return renderHeader({
          ...
          className: clsx(
            ...
            eq$1(date, getNow(), 'day') && reactStyle['rbc-now']
          ),
        })
      }
    ...
    _proto.getRowLimit = function getRowLimit() {
      ...
      return Math.max(Math.floor(eventSpace / eventHeight), 5)
      /*todo显示几行行程*/
    }
  ...
  var omit = flatRest(function(object, paths) {
    ...
    if (isDeep) {
      result = baseClone(
        result,
        CLONE_DEEP_FLAG$2 | CLONE_FLAT_FLAG$1 | CLONE_SYMBOLS_FLAG$2,
        customOmitClone
      )
    }
  ...
  var defaults = baseRest(function(object, sources) {
    ...
    while (++index < length) {
      ...
      while (++propsIndex < propsLength) {
        ...
        if (
          value === undefined ||
          (eq(value, objectProto$g[key]) && !hasOwnProperty$e.call(object, key))
        ) {
