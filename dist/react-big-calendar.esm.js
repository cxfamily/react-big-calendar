!(function(e, t) {
  ...
  function vr(e) {
    ...
    if (c) {
      ...
      w === Bn(n) &&
        ...
        o === An && ((g = Tn), (d -= w[_] - r.width), (d *= s ? 1 : -1))
    }
    var D,
  ...
  function Nr(e) {
    return [kn, Tn, jn, An].some(function(t) {
      return e[t] >= 0
    })
  }
  function Pr(e, t, n) {
              ...
              return (
                (e[n] = (function(e, t, n) {
                  ...
                  return (
                    (i = i || 0),
                    (s = (s || 0) * o),
                    [An, Tn].indexOf(r) >= 0 ? { x: s, y: i } : { x: i, y: s }
                  )
                })(n, t.rects, a)),
                e
              )
          ...
          if (_) {
            if (a || s) {
              var x = 'y' === w ? kn : An,
                ...
                X = _[w] + V - K
              if (a) {
                var q = lr(p ? sr(A, $) : A, T, p ? ir(N, X) : N)
                ;(_[w] = q), (O[w] = q - T)
              }
              if (s) {
                var G = 'x' === w ? kn : An,
      ...
      },
      {
        ...
        fn: function(e) {
          var t,
            ...
            s = Vn(n.placement),
            c = ar(s),
            l = [An, Tn].indexOf(s) >= 0 ? 'height' : 'width'
          if (a && i) {
  ...
  var ja = 'object' == typeof e && e && !e.nodeType && e,
    ...
    Aa = Ta && Ta.exports === ja && ce.process,
    Na = (function() {
      try {
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  this.renderHeaders(l[0])
                ),
                l.map(this.renderWeek),
