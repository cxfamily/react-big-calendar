!(function(e, t) {
        ...
        return (
          ...
          (t.readerDateHeading = function(e) {
            var n,
              ...
              p = l.events,
              v = l.reactStyle,
              h = t.state.clickActiveEle,
              m = ut(o) !== ut(u),
              g = Ge(o, u, 'day'),
              y = f(o),
              b = d.format(o, 'dateFormat'),
              w = t.props.components.dateHeader || ps,
              E = function(e) {
              ...
              S =
                p.filter(function(e) {
                  return (
                    E(e).getFullYear() === o.getFullYear() &&
                    E(e).getMonth() === o.getMonth() &&
                    E(e).getDate() <= b &&
                    _(e).getDate() >= b &&
                    (E(e).getDate() === _(e).getDate() ||
                      (E(e).getDate() !== _(e).getDate() &&
                        Date.parse(e.end) >
                          Date.parse(
                            o.getFullYear() +
            ...
            return r.createElement(
              ...
              i({}, c, {
                className: G(
                  ...
                  m && v['rbc-off-range'],
                  g && v['rbc-current'],
                  (null == S ? void 0 : S.length) > 0 && v['rbc-data'],
                  (null == (n = M[0]) ? void 0 : n.value) && v['rbc-active']
                ),
                role: 'cell',
              }),
              r.createElement(w, {
                ...
                onDrillDown: function(e) {
                  return t.handleHeadingClick(o, S, e, D)
                },
              })
            )
          }),
  ...
  function Ps(e, t, n) {
    return (
      ...
      function() {
        for (
          var r = arguments, o = -1, a = Ns(r.length - t, 0), i = Array(a);
          ++o < a;
      ...
      N = i(
        ...
        g
          ? (((t = {
              ...
              height: Xs(x),
              width: 'calc(' + T + ' + 10px)',
            })[l ? 'right' : 'left'] = Xs(Math.max(0, j))),
            t)
          : (((n = { top: Xs(k), width: Xs(T), height: Xs(x) })[
              l ? 'right' : 'left'
            ] = Xs(j)),
            n)
      )
  ...
  function Vc(e, t, n) {
    var r = e[t]
    ;(Uc.call(e, t) && Dt(r, n) && (void 0 !== n || t in e)) || Hc(e, t, n)
  }
  function Bc(e, t, n, r) {
    var o = !n
    n || (n = {})
    ...
    eu = Is(function(e, t) {
      ...
      for (o && Lt(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = $c(a), s = -1, c = i.length; ++s < c; ) {
          var l = i[s],
            u = e[l]
          ;(void 0 === u || (Dt(u, Jl[l]) && !Ql.call(e, l))) && (e[l] = a[l])
        }
      return e
    })
  var tu = function(e) {
